...
#ifndef INC_ILI9488_STM32_DRIVER_H_
#define INC_ILI9488_STM32_DRIVER_H_
...
#define RST_A() HAL_GPIO_WritePin(RESET_GPIO_Port,RESET_Pin,GPIO_PIN_RESET)
#define RST_D() HAL_GPIO_WritePin(RESET_GPIO_Port,RESET_Pin,GPIO_PIN_SET)
...
#define ILI9488_WRDISBV 0x51 //This command is used to adjust the brightness value of the display.

#define ILI9488_EXTC    0xB0
...
#define ILI9488_		0xF6
#define ILI9488_ADJCTR  0xF7
...
#define ILI9488_TRANSPARENT 		0x0120 // This is actually a dark green
...
void ILI9488_printText(char text[], int16_t x, int16_t y, uint16_t color,
		uint16_t bg, uint8_t size);
...
#endif /* INC_ILI9488_STM32_DRIVER_H_ */
